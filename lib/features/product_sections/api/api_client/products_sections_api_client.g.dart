...
part of 'products_sections_api_client.dart';
...
class _ProductsSectionsApiClient implements ProductsSectionsApiClient {
  _ProductsSectionsApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<CategoriesResponse> getCategories({int? limit, int? page}) async {
  ...
  @override
  Future<OccasionsResponse> getOccasions({int? limit, int? page}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'limit': limit, r'page': page};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
