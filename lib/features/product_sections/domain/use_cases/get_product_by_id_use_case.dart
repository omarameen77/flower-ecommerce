...
class GetProductByIdUseCase {
  ...
  GetProductByIdUseCase({required this.productsSectionRepo});

  Future<BaseResponse<ProductEntity>> call(String id) async {
    return productsSectionRepo.getProductById(id);
  }
}
